...
{
    public partial class Solves2 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    SolvedChallengesId = table.Column<int>(type: "int", nullable: false),
                    UserSolvesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChallengeUser", x => new { x.SolvedChallengesId, x.UserSolvesId });
                    table.ForeignKey(
