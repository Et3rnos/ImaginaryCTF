        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Attachments = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    ...
                    Flag = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    Points = table.Column<uint>(type: "int unsigned", nullable: false),
                    Solves = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    State = table.Column<int>(type: "int", nullable: false),
                    Writeup = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChallengeReleaseChannelId = table.Column<ulong>(type: "bigint unsigned", nullable: false),
                    ChallengeSolvesChannelId = table.Column<ulong>(type: "bigint unsigned", nullable: false),
                    LeaderboardChannelId = table.Column<ulong>(type: "bigint unsigned", nullable: false),
                    LogsChannelId = table.Column<ulong>(type: "bigint unsigned", nullable: false),
                    ReleaseTime = table.Column<uint>(type: "int unsigned", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChallengeTitle = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscordUsername = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "365af12d-bbee-42de-a35b-63a5a6fdb69e", "ce3d1bd3-06d4-4165-9197-c35bfeb54f36", "Administrator", "ADMINISTRATOR" });
